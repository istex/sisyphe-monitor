...
(function () {
  function L (a) {
    function m (a) {
      ...
      if (f !== 92) return f;
      var b = a.charAt(1);
      return (f = r[b]) ? f : b >= '0' && b <= '7' ? parseInt(a.substring(1), 8) : b === 'u' || b === 'x' ? parseInt(a.substring(2), 16) : a.charCodeAt(1);
    }
    ...
    function e (a) {
      for (var l = a.d, p = [l, 'pln'], d = 0, g = a.a.match(y) || [], r = {}, n = 0, z = g.length; n < z; ++n) {
        ...
        if (typeof b === 'string') c = !1;
          ...
          if ((c = b.length >= 5 && b.substring(0, 5) === 'lang-') && !(o && typeof o[1] === 'string')) c = !1, b = 'src';
          c || (r[f] = b);
        }
        i = d;
        d += f.length;
